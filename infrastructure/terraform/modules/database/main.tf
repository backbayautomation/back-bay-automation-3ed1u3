# Azure Database Infrastructure Module
# Provider versions
terraform {
  required_providers {
    azurerm = {
...
resource "azurerm_mssql_server" "main" {
  ...
  azuread_administrator {
    login_username = var.sql_server_config.azuread_administrator.login_username
    object_id     = var.sql_server_config.azuread_administrator.object_id
    tenant_id     = var.sql_server_config.azuread_administrator.tenant_id
  }
