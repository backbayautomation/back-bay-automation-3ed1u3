...
/**
 * Storage item wrapper including data and metadata
 */
...
export const setLocalStorage = <T>(
    ...
    try {
        ...
        return {
            success: false,
            data: void 0,
            error: 'Failed to set localStorage item',
            message: error instanceof Error ? error.message : 'Unknown error',
            statusCode: 500,
            metadata: {}
        };
...
export const getLocalStorage = <T>(key: string): ApiResponse<T | null> => {
    try {
        ...
        return {
            success: false,
            data: null,
            error: 'Failed to get localStorage item',
            message: error instanceof Error ? error.message : 'Unknown error',
            statusCode: 500,
            metadata: {}
        };
...
export const setSessionStorage = <T>(
    ...
    try {
        ...
        return {
            success: false,
            data: void 0,
            error: 'Failed to set sessionStorage item',
            message: error instanceof Error ? error.message : 'Unknown error',
            statusCode: 500,
            metadata: {}
        };
